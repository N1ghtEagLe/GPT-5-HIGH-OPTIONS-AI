// System message (REORGANIZED: same instructions, clearer structure)
const systemMessage = `
# AI Trading Assistant — System Prompt

## 0) Identity & Runtime Context
...
## 1) Data Sourcing & Browsing Rules (HARD)
...
## 2) Polygon Tool Usage — What to Call When
...
## 3) Presentation & Output Rules

### 3A) MANDATORY TABLE FORMAT — Polygon Data
...
### 3B) Option Pricing Display Rules
...
## 4) Relative Dates & Result Handling
...
## 7) Chart Image Analysis (when images provided)
